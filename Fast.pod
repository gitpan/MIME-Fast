...
B<NOTE>: this function is not yet available in gmime 2.0.8.
...
B<NOTE>:
The MIME::Fast::Filter::Enriched filter is not yet available in gmime 2.0.8.
...
Gmime version 2.0.8 supports only one colour for citation text.
...
This module MIME::Fast requires perl 5.8.x and gmime 2.0.8 or higher.
